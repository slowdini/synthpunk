...
import { loadSyntaxMapping, loadFontStyles } from "../syntaxMapping";
...
describe("generateZedTheme", () => {
  ...
  test("has syntax colors", () => {
    ...
    const syntax = theme.themes[0].style.syntax as Record<string, { color: string }>;
  ...
  test("light theme syntax has different keyword color from dark", () => {
    ...
    const darkSyntax = theme.themes[0].style.syntax as Record<string, { color: string }>;
    const lightSyntax = theme.themes[1].style.syntax as Record<string, { color: string }>;
